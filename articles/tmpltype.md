...
AST解析やコード生成など、日々の開発ではあまり触れない技術でしたが、生成AIの力を借りることでアイディアを形にしやすくなったと感じています。生成されたコードを写経しながら調べることで学習も捗りましたし、OSSでよく見る examples ディレクトリの整備もスムーズでした。

実装してみるとASTまわりは込み入った処理になりやすく、この辺りは改善ポイントだと感じています。
