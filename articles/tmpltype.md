...
AST解析やコード生成など、日々の開発ではあまり触れない技術でしたが、生成AIの力を借りることでアイディアを形にしやすくなったと感じています。子育ての合間のような細切れの時間でも少しずつ進められたのもの、個人的に嬉しいポイントでした。生成されたコードを調べながら写経すれば学習にもなります。

ただ、AST まわりの実装は込み入りやすく、まだ改善の余地がありそうです。
